...
$insertGoTo = "<div class='success'>Bienvenido(a)</div><script type='text/javascript'>window.location.href = 'index.html#page';localStorage.setItem('username','".$_POST['email']."');initData('".$_POST['email']."');</script>";
echo $insertGoTo;
  }
  }
?>